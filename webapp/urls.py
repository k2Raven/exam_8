...
from webapp.views import IndexView, DetailProductView, CreateProductView, UpdateProductView, DeleteProductView, \
    CreateReviewView, UpdateReviewView, DeleteReviewView, ListNoModeratedReviewView
...
urlpatterns = [
    ...
    path('reviews/no_moderated/', ListNoModeratedReviewView.as_view(), name="no_moderated_reviews")
]
